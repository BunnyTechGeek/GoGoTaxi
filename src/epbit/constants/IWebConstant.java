...
public interface IWebConstant {
	 ...
	 * 
	 */
	String Browser_GOOGLEAPI_KEY = "AIzaSyAVUqmkdQvTPiCjWybWzJodgHxSNgyCQPw";
	
	String SERVER_KEY_FORGCM="AIzaSyCHF9DM4zIWvbY7X4ndFE5mtcjjVhZYwvk";
	/**
	 * GCM PROJECT ID used fro notifications
	 * ]myan cab
	 */
	public static final String SENDER_ID = "534451716289";
	/**
	 * SPLASH TIME OUT
	 */
