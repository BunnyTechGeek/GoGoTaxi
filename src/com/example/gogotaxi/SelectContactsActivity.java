	...
	protected void onCreate(Bundle savedInstanceState) {
		 ...
		 setContentView(R.layout.selectcontacts_email);
	        ...
	        select.setOnClickListener(new OnClickListener() {
	            ...
	            public void onClick(View v) {
	                ...
	                Toast.makeText(SelectContactsActivity.this, checkedcontacts, Toast.LENGTH_SHORT).show();
	                AlertDialog.Builder builder = new AlertDialog.Builder(SelectContactsActivity.this);
	               
	                    builder.setTitle(""+contacts.size()+" Contacts has been Selected !!");
	                ...
	                builder.setPositiveButton("No", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							returnIntent.putStringArrayListExtra("data",contacts);
	        ...
	        cancel.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							startActivity(new Intent(SelectContactsActivity.this,
									ReferActivity.class)
	    ...
	    class MyAdapter extends BaseAdapter implements
	        ...
	        MyAdapter() {
	            ...
	            mInflater = (LayoutInflater) SelectContactsActivity.this
